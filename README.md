...
(**BDALab**). For more information, please contact the main author: Zoltan Galaz at <galaz@feec.vutbr.cz>.

* * * * * * * * *
 
## Installation
```
git clone git@github.com:BDALab/datascience_helpers.git
cd datascience_helpers
